                ...
                <div class="card-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($project->status == 0)
                                    <a href="/karyawan/menu/project/ongoing/edit/{{ $project->id }}" class="btn btn-info">Edit</a>
                                @else
                                    <a href="/karyawan/menu/project/done/{{ $project->id }}/view" class="btn btn-primary"><i class="fas fa-eye"></i></a>
                                @endif
